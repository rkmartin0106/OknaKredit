        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://wa.me/79219650040" aria-label="WhatsApp" className="text-white/50 hover:text-brand-red transition-colors">
              ...
              <a href="tel:+79219650040" aria-label="MAX" className="text-white/50 hover:text-brand-red transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex gap-2">
                ...
                <span>г. Санкт-Петербург,<br />шоссе Революции, д. 88Н</span>
              </li>
              <li className="flex gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-brand-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
