    ...
    <footer className="bg-brand-navyDark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" aria-label="ВКонтакте" className="text-white/50 hover:text-brand-gold transition-colors">
              ...
              <a href="#" aria-label="Telegram" className="text-white/50 hover:text-brand-gold transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex gap-2">
                ...
                <div className="flex flex-col gap-0.5">
                  <a href="tel:+78125291104" className="hover:text-brand-gold transition-colors">+7 (812) 529-11-04</a>
                  <a href="tel:+78125291656" className="hover:text-brand-gold transition-colors">+7 (812) 529-16-56</a>
                </div>
              </li>
              <li className="flex gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:info@oknakredit.ru" className="hover:text-brand-gold transition-colors">info@oknakredit.ru</a>
              </li>
              <li className="flex gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-white/40">
          <span>© {new Date().getFullYear()} ОкнаКредит. Все права защищены.</span>
