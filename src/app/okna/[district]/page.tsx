...
const districtFaqs = (dName: string, dNameIn: string) => [
  ...
  },
  {
    ...
    a: `Стоимость металлопластиковых окон ${dNameIn} - от 5200 ₽/м² для окна «Стандарт» с однокамерным стеклопакетом. Двухкамерный вариант «Комфорт» - от 7700 ₽/м². Точный расчёт делается после бесплатного замера.`,
  },
  {
    q: `Как быстро установят окна ${dNameIn}?`,
    a: `Производство занимает 5–10 рабочих дней. Монтаж квартиры (4–6 окон) выполняется за один день. В стоимость входит демонтаж старых окон, установка, откосы, подоконники и вывоз мусора.`,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ["«Стандарт» ПВХ REHAU и IVAPER",       "Однокамерный 4-16-4",        "5200 ₽/м²"],
                  ["«Комфорт» ПВХ REHAU и IVAPER",        "Двухкамерный 4-10-4-10-4",   "7700 ₽/м²"],
