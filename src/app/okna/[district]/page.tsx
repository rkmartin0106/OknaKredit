...
export default function DistrictPage({ params }: Props) {
  ...
  const localSchema = {
    ...localBusinessSchema,
    description: `Производство и установка металлопластиковых окон ${d.nameIn}. Профиль GEALAN, фурнитура ROTO FRANK. Бесплатный замер. Монтаж под ключ.`,
    areaServed: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ["«Стандарт» ПВХ GEALAN S3000",         "Однокамерный 4-16-4",        "2,6 Вт/м²·К", "4 900 ₽/м²"],
                  ["«Комфорт» ПВХ GEALAN S8000 IQ",       "Двухкамерный 4-10-4-10-4",   "1,8 Вт/м²·К", "7 200 ₽/м²"],
                  ["Энергосберегающее GEALAN S8000 IQ",   "Двухкамерный с i-coating",   "1,0 Вт/м²·К", "9 800 ₽/м²"],
