...
export const metadata: Metadata = {
  title: "О компании",
  description:
    "Окна-Кредит — производитель металлопластиковых окон с 2009 года. Профили RIHAU и IVAPER, фурнитура ROTO FRANK. Более 2500 выполненных объектов.",
};
...
const milestones = [
  ...
  { year: "2023", event: "Более 2 500 выполненных объектов. Официальный партнёр RIHAU, IVAPER и ROTO FRANK." },
];

const certifications = [
  "Профили RIHAU и IVAPER — сертификат соответствия Госстрой",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 mt-6 text-brand-gray leading-relaxed">
              <p>
                Окна-Кредит появился из простой идеи: зачем переплачивать дилерам, если можно купить окно напрямую у того, кто его делает? В 2009 году мы запустили собственное производство на немецком оборудовании с профилями RIHAU и IVAPER и фурнитурой ROTO FRANK.
              </p>
              <p>
                С тех пор мы выполнили более 2 500 объектов — от замены одного окна в квартире до полного остекления многоквартирных домов и коммерческих помещений. Каждый заказ ведёт персональный менеджер от замера до подписания акта сдачи-приёмки.
              </p>
              <p>
