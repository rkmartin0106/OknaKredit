...
const benefits = [
  {
    ...
    desc: "Профили RIHAU и IVAPER со сроком службы 50 условных лет. Фурнитура ROTO FRANK с запором по периметру. Микропроветривание включено.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Окна в рассрочку без переплаты или в кредит от 6 до 36 месяцев. Оформление прямо на объекте.",
  },
];
...
const process = [
  ...
  { step: "02", title: "Договор и производство", desc: "Подписываем договор, запускаем изготовление. Срок производства — от 3 рабочих дней." },
