...
const services = [
  ...
  },
  {
    ...
    desc: "В течение гарантийного срока (5 лет) устраняем любые неисправности бесплатно. Регулировка, замена уплотнителей, подтяжка фурнитуры.",
    included: true,
    details: ["Гарантия 5 лет на изделие и монтаж", "Выезд мастера бесплатно", "Регулировка и ремонт включены"],
  },
  {
