  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xs text-brand-gray">Замерщик: <a href="tel:+79219650040" className="hover:text-brand-blue transition-colors">+7 (921) 965-00-40</a> (ежедневно)</span>
        <div className="flex gap-3 mt-2">
          <a href="https://wa.me/79219650040" aria-label="WhatsApp" className="text-brand-gray hover:text-brand-blue transition-colors">
          ...
          <a href="tel:+79219650040" aria-label="MAX" className="text-brand-gray hover:text-brand-blue transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
