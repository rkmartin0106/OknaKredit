  ...
  if (slug === "kak-vybrat-okna-dlya-kvartiry") {
    return (
      <>
        ...
        <ul>
          <li><strong>5-камерный профиль RIHAU и IVAPER</strong> — базовый профиль, хорош для дач, кладовых, нежилых помещений.</li>
          <li><strong>6-камерный профиль RIHAU и IVAPER</strong> — рекомендован для жилых квартир. Усиленное стальное армирование, лучшая теплоизоляция.</li>
        </ul>
        ...
        <p>Оптимальный выбор: 6-камерный профиль RIHAU и IVAPER + двухкамерный стеклопакет с i-coating + фурнитура ROTO FRANK. Стоимость — от 7 500–9 500 ₽/м², срок службы — 25+ лет.</p>
      </>
    );
  }
