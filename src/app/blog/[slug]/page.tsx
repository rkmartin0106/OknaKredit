  ...
  if (slug === "kak-vybrat-okna-dlya-kvartiry") {
    return (
      <>
        ...
        <ul>
          <li><strong>GEALAN S3000 (5 камер)</strong> — базовый профиль, хорош для дач, кладовых, нежилых помещений.</li>
          <li><strong>GEALAN S8000 IQ (6 камер)</strong> — рекомендован для жилых квартир. Усиленное стальное армирование, лучшая теплоизоляция.</li>
        </ul>
        ...
        <p>Фурнитура определяет удобство эксплуатации и безопасность. ROTO FRANK (Германия) — мировой стандарт. Периметральное запирание по всему периметру створки исключает деформацию и повышает защиту от взлома до класса RC2.</p>
        ...
        <p>Оптимальный выбор: профиль GEALAN S8000 IQ + двухкамерный стеклопакет с i-coating + фурнитура ROTO FRANK. Стоимость — от 7 500–9 500 ₽/м², срок службы — 25+ лет.</p>
      </>
    );
  }
